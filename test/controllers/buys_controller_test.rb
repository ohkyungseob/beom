...
class BuysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post buys_url, params: { buy: { episode_id: @buy.episode_id, webtoon_id: @buy.webtoon_id } }
    end
  ...
  test "should update buy" do
    patch buy_url(@buy), params: { buy: { episode_id: @buy.episode_id, webtoon_id: @buy.webtoon_id } }
